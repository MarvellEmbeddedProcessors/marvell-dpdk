...
int
roc_nix_inl_custom_profile_setup(struct roc_nix *roc_nix, uint64_t def_cfg, const uint64_t gen_cfg,
				 const uint64_t extract_cfg, const uint64_t *prot_field_cfg,
